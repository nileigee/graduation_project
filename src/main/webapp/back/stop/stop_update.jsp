        ...
        <div class="col-sm-4" id="div_form">
            <form  role="form" >
                ...
                <div class="form-group">
                    <input type="hidden" id="stopId" name="stopId" value="${stopById.stopId}" >
                </div>
                <div class="form-group">
                    <label for="stopName">站点名：</label>
                    <input type="text" class="form-control" id="stopName" name="stopName" value="${stopById.stopName}">
                </div>

                <div class="form-group">
                    <label for="stopType">站点类型：</label>
                    <input type="text" class="form-control" id="stopType" name="stopType" value="${stopById.stopType}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lng" name="stopLongitude" value="${stopById.stopLongitude}">
                </div>

                <div class="form-group">
                    <label for="lat">站点纬度：</label>
                    <input type="text" class="form-control" id="lat" name="stopLatitude" value="${stopById.stopLatitude}">
                </div>

                <div class="form-group">
                    <label for="particular_site">详细地址：</label>
                    <input type="text" class="form-control" id="particular_site" name="stopAddress" value="${stopById.stopAddress}">
                </div>

                <div class="form-group">
                    <label for="workerId">负责人</label>
                    <select class="form-control" id="workerId" name="workerId">
                        <c:forEach items="${stopWorkerList}" var="worker" varStatus="s">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="stopDescribe" name="stopDescribe">${stopById.stopDescribe}
                     </textarea>
                </div>

                <div class="form-group">
                    <a class="btn btn-primary" style="width: 450px;line-height: 25px" type="submit"
                       href="javascript:$('#content').load('${pageContext.request.contextPath}/stopInfo/updateStop',
                {'stopId':$('#stopId').val(),'stopName':$('#stopName').val(),'stopType':$('#stopType').val(),'stopLongitude':$('#lng').val(),'stopLatitude':$('#lat').val(),
                 'stopAddress':$('#particular_site').val(),'workerId':$('#workerId').val(),'stopStatus':$('#stopStatus').val(),'stopDescribe':$('#stopDescribe').val()});">更改</a>
