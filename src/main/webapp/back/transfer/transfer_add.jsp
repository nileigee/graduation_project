        ...
        <div class="col-sm-4" id="div_form">
            <form  role="form" >
                <div class="form-group">
                    <label for="transferName">中转站名：</label>
                    <input type="text" class="form-control" id="transferName" name="transferName" placeholder="请输入中转站名称">
                </div>

                <div class="form-group">
                    <label for="transferType">类型：</label>
                    <input type="text" class="form-control" id="transferType" name="transferType" placeholder="请输入站点类型">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lng" name="transferLongitude" placeholder="中转站经度">
                </div>

                <div class="form-group">
                    <label for="lat">站点纬度：</label>
                    <input type="text" class="form-control" id="lat" name="transferLatitude" placeholder="中转站纬度">
                </div>

                <div class="form-group">
                    <label for="particular_site">详细地址：</label>
                    <input type="text" class="form-control" id="particular_site" name="transferAddress" placeholder="地址">
                </div>

                <div class="form-group">
                    <label for="workerId">负责人</label>
                    <select class="form-control" id="workerId" name="workerId">
                        <c:forEach items="${allTransferWorkers}" var="worker" varStatus="s">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="transferDescribe" name="transferDescribe" placeholder="请输入对中转站的描述">
                </textarea>
                </div>

                <div class="form-group" >
                    <a class="btn btn-primary" style="width: 450px;line-height: 25px" type="submit"
                       href="javascript:$('#content').load('${pageContext.request.contextPath}/transferInfo/saveTransfer',
                {'transferName':$('#transferName').val(),'transferType':$('#transferType').val(),'transferLongitude':$('#lng').val(),'transferLatitude':$('#lat').val(),
                 'transferAddress':$('#particular_site').val(),'workerId':$('#workerId').val(),'transferStatus':$('#transferStatus').val(),'transferDescribe':$('#transferDescribe').val()});">添加</a>
                </div>
